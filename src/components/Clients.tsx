...
const Clients = () => {
  const clients = [
    { name: 'PharmaCorp', color: 'from-blue-500 to-cyan-500' },
    { name: 'MediTech', color: 'from-purple-500 to-pink-500' },
    { name: 'HealthPlus', color: 'from-green-500 to-teal-500' },
    { name: 'VitalCare', color: 'from-orange-500 to-red-500' },
    { name: 'BioMed', color: 'from-indigo-500 to-purple-500' },
    { name: 'GlobalHealth', color: 'from-pink-500 to-rose-500' },
    { name: 'MedSupply', color: 'from-cyan-500 to-blue-500' },
    { name: 'PharmaLab', color: 'from-yellow-500 to-orange-500' },
    { name: 'MedCore', color: 'from-teal-500 to-green-500' },
    { name: 'LifeScience', color: 'from-violet-500 to-purple-500' }
  ];
